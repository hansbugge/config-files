(custom-set-variables
 ...
 '(TeX-command-list
   '(("TeX"
      ...
      "Run plain TeX")
     ("XeLatexMk"
      "latexmk -pv -pdflatex=\"xelatex --synctex=1 %O %S\" -pdf -dvi- -ps- %t"
      TeX-run-TeX nil (latex-mode))
     ("LatexMk" "latexmk -pv %t" TeX-run-TeX nil (latex-mode))
 ...
 '(custom-safe-themes
   '("2b0fcc7cc9be4c09ec5c75405260a85e41691abb1ee28d29fcd5521e4fca575b"
     ...
     "bf58fd87997ec29aef8edfdd8f4ab854f5389e9d23a63b0835c497987a6c5084"
 ...
 '(package-selected-packages
   '(aggresive-indent aggresive-indent-mode aggressive-indent apheleia
                      astro-ts-mode attrap-attrap autodisass-java-bytecode avy
                      cider cider-eval-sexp-fu clojure clojure-mode company
                      company-lsp company-restclient csv-mode dhall-mode
                      dockerfile-mode editorconfig fill-column-indicator
                      flychdeck-elm flycheck flycheck-clj-kondo flycheck-elm
                      flymake-hlint fsharp-mode gcmh git-modes gitignore-mode
                      gmch gmch-mode god-mode gradle gradle-mode groovy-mode
                      haskell-mode helm-hoogle htlmize htmlize hungry-delete
                      idris-mode intero keycast keycast-mode kotlin-mode
                      longlines-mode lsp-jedi lsp-mode lsp-ui magit marginalia
                      markdown-mode multiple-cursors neotree nix-buffer nix-mode
                      nyan-mode orderless prettier-js rainbow-delimiters
                      restclient restclient-mode rjsx-mode smartparens sml-mode
                      tide typescript-mode undo-tree vertico visual-fill-column
                      web-mode wgrep ws-butler yaml-mode z3-mode zig-mode))
 '(safe-local-variable-values
   '((eval font-lock-add-keywords nil
     ...
     (cider-shadow-default-options . ":app") (cider-default-cljs-repl . shadow)
     (cider-shadow-cljs-default-options . ":app")
     (intero-targets "sic:lib" "sic:test:sic-test")
     (intero-targets "language-lib:lib" "language-lib:test:dil-service-test")
     (intero-targets) (intero-targets "language-lib:test:dil-service-test")
     (TeX-master . "../thesis")
     ...
     (dante-target . "test:dil-service-test") (haskell-process-use-ghci . t)
     (haskell-indent-spaces . 4) (preview-scale-function . 1.2)
     (eval agda-input-add-translations
           '(("bi" . "mathbb{I}") ("longmapsto" . "longmapsto")))
     (eval agda-input-add-translations
           '(("bi" . "mathbb{I}") ("longmapsto" . "⟼")))
     (eval agda-input-add-translations '(("bi" . "𝕀") ("longmapsto" . "⟼")))
